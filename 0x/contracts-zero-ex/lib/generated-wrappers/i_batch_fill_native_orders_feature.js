...
exports.IBatchFillNativeOrdersFeatureContract = void 0;
...
class IBatchFillNativeOrdersFeatureContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = IBatchFillNativeOrdersFeatureContract.deployedBytecode, encoderOverrides) {
        super('IBatchFillNativeOrdersFeature', IBatchFillNativeOrdersFeatureContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encoderOverrides);
