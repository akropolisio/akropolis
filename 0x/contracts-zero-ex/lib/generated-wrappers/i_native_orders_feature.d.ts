...
export declare type INativeOrdersFeatureEventArgs = INativeOrdersFeatureLimitOrderFilledEventArgs | INativeOrdersFeatureOrderCancelledEventArgs | INativeOrdersFeatureOrderSignerRegisteredEventArgs | INativeOrdersFeaturePairCancelledLimitOrdersEventArgs | INativeOrdersFeaturePairCancelledRfqOrdersEventArgs | INativeOrdersFeatureRfqOrderFilledEventArgs | INativeOrdersFeatureRfqOrderOriginsAllowedEventArgs;
...
export interface INativeOrdersFeatureOrderSignerRegisteredEventArgs extends DecodedLogArgs {
    maker: string;
    signer: string;
    allowed: boolean;
}
