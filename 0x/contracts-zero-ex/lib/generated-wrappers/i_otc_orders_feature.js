...
exports.IOtcOrdersFeatureContract = exports.IOtcOrdersFeatureEvents = void 0;
...
var IOtcOrdersFeatureEvents;
(function (IOtcOrdersFeatureEvents) {
    IOtcOrdersFeatureEvents["OtcOrderFilled"] = "OtcOrderFilled";
})(IOtcOrdersFeatureEvents = exports.IOtcOrdersFeatureEvents || (exports.IOtcOrdersFeatureEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
class IOtcOrdersFeatureContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = IOtcOrdersFeatureContract.deployedBytecode, encoderOverrides) {
        super('IOtcOrdersFeature', IOtcOrdersFeatureContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encoderOverrides);
        this._methodABIIndex = {};
        utils_1.classUtils.bindAll(this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        this._subscriptionManager = new base_contract_1.SubscriptionManager(IOtcOrdersFeatureContract.ABI(), this._web3Wrapper);
        IOtcOrdersFeatureContract.ABI().forEach((item, index) => {
    ...
    static deployFrom0xArtifactAsync(artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return IOtcOrdersFeatureContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly);
        });
    }
    static deployWithLibrariesFrom0xArtifactAsync(artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const libraryAddresses = yield IOtcOrdersFeatureContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults);
    ...
    static deployAsync(bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            utils_1.logUtils.log(`IOtcOrdersFeature successfully deployed at ${txReceipt.contractAddress}`);
            const contractInstance = new IOtcOrdersFeatureContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
            ...
            for (const link of Object.values(links)) {
                for (const libraryName of Object.keys(link)) {
                    if (!libraryAddresses[libraryName]) {
                        ...
                        yield IOtcOrdersFeatureContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses);
                        // Deploy this library.
    ...
    getFunctionSignature(methodName) {
        ...
        const methodAbi = IOtcOrdersFeatureContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
 ...
 * tx.origin address and nonce bucket.
    ...
    lastOtcTxOriginNonce(txOrigin, nonceBucket) {
        ...
        return {
            ...
            getABIEncodedTransactionData() {
                return self._strictEncodeArguments(functionSignature, [txOrigin.toLowerCase(),
                    nonceBucket
                ]);
            },
        };
    ...
    subscribe(eventName, indexFilterValues, callback, isVerbose = false, blockPollingIntervalMs) {
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, IOtcOrdersFeatureEvents);
        ...
        const subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, IOtcOrdersFeatureContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
    ...
    getLogsAsync(eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
            const logs = yield this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, IOtcOrdersFeatureContract.ABI());
            return logs;
        });
    }
}
exports.IOtcOrdersFeatureContract = IOtcOrdersFeatureContract;
IOtcOrdersFeatureContract.contractName = 'IOtcOrdersFeature';
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_otc_orders_feature.js.map