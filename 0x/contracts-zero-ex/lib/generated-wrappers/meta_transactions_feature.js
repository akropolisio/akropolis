...
exports.MetaTransactionsFeatureContract = exports.MetaTransactionsFeatureEvents = void 0;
...
class MetaTransactionsFeatureContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = MetaTransactionsFeatureContract.deployedBytecode, encoderOverrides) {
        super('MetaTransactionsFeature', MetaTransactionsFeatureContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encoderOverrides);
