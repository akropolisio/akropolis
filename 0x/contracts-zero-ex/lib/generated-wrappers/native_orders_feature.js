...
exports.NativeOrdersFeatureContract = exports.NativeOrdersFeatureEvents = void 0;
...
(function (NativeOrdersFeatureEvents) {
    ...
    NativeOrdersFeatureEvents["OrderSignerRegistered"] = "OrderSignerRegistered";
...
class NativeOrdersFeatureContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = NativeOrdersFeatureContract.deployedBytecode, encoderOverrides) {
        super('NativeOrdersFeature', NativeOrdersFeatureContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encoderOverrides);
    ...
    static deployFrom0xArtifactAsync(artifact, supportedProvider, txDefaults, logDecodeDependencies, zeroExAddress, weth, staking, feeCollectorController, protocolFeeMultiplier) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return NativeOrdersFeatureContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, zeroExAddress, weth, staking, feeCollectorController, protocolFeeMultiplier);
        });
    }
    static deployWithLibrariesFrom0xArtifactAsync(artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies, zeroExAddress, weth, staking, feeCollectorController, protocolFeeMultiplier) {
        return __awaiter(this, void 0, void 0, function* () {
            assert_1.assert.doesConformToSchema('txDefaults', txDefaults, json_schemas_1.schemas.txDataSchema);
            if (artifact.compilerOutput === undefined) {
                throw new Error('Compiler output not found in the artifact file');
    ...
    static deployAsync(bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, zeroExAddress, weth, staking, feeCollectorController, protocolFeeMultiplier) {
        return __awaiter(this, void 0, void 0, function* () {
