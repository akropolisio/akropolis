...
export declare type OtcOrdersFeatureEventArgs = OtcOrdersFeatureOtcOrderFilledEventArgs;
export declare enum OtcOrdersFeatureEvents {
    OtcOrderFilled = "OtcOrderFilled"
}
export interface OtcOrdersFeatureOtcOrderFilledEventArgs extends DecodedLogArgs {
    orderHash: string;
    maker: string;
    taker: string;
    makerToken: string;
...
export declare class OtcOrdersFeatureContract extends BaseContract {
    /**
     * @ignore
     */
    ...
    }, zeroExAddress: string, weth: string): Promise<OtcOrdersFeatureContract>;
 ...
 * Should be delegatecalled by `Migrate.migrate()`.
    ...
    /**
     * Subscribe to an event type emitted by the OtcOrdersFeature contract.
     * @param eventName The OtcOrdersFeature contract event you would like to subscribe to.
     ...
     */
    subscribe<ArgsType extends OtcOrdersFeatureEventArgs>(eventName: OtcOrdersFeatureEvents, indexFilterValues: IndexedFilterValues, callback: EventCallback<ArgsType>, isVerbose?: boolean, blockPollingIntervalMs?: number): string;
    /**
     ...
     */
    getLogsAsync<ArgsType extends OtcOrdersFeatureEventArgs>(eventName: OtcOrdersFeatureEvents, blockRange: BlockRange, indexFilterValues: IndexedFilterValues): Promise<Array<LogWithDecodedArgs<ArgsType>>>;
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: {
        [contractName: string]: ContractAbi;
    }, deployedBytecode?: string | undefined, encoderOverrides?: Partial<EncoderOverrides>);
}
//# sourceMappingURL=otc_orders_feature.d.ts.map