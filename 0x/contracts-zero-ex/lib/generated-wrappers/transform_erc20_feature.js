...
exports.TransformERC20FeatureContract = exports.TransformERC20FeatureEvents = void 0;
...
class TransformERC20FeatureContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = TransformERC20FeatureContract.deployedBytecode, encoderOverrides) {
        super('TransformERC20Feature', TransformERC20FeatureContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encoderOverrides);
 ...
 * to an ERC20 `outputToken`.
    ...
    ;
    /**
     * Wrapper for `transformERC20`. This selector will be temporarily
 ...
 * 0x API back to `transformERC20`, and deregister this function.
     ...
     *     balance(s)        in sequence.
     */
    transformERC20Staging(inputToken, outputToken, inputTokenAmount, minOutputTokenAmount, transformations) {
        const self = this;
        assert_1.assert.isString('inputToken', inputToken);
        assert_1.assert.isString('outputToken', outputToken);
        assert_1.assert.isBigNumber('inputTokenAmount', inputTokenAmount);
        assert_1.assert.isBigNumber('minOutputTokenAmount', minOutputTokenAmount);
        assert_1.assert.isArray('transformations', transformations);
        const functionSignature = 'transformERC20Staging(address,address,uint256,uint256,(uint32,bytes)[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
