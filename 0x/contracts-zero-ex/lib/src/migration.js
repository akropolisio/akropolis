...
exports.fullMigrateAsync = exports.deployFullFeaturesAsync = exports.initialMigrateAsync = exports.deployBootstrapFeaturesAsync = void 0;
...
function deployBootstrapFeaturesAsync(provider, txDefaults, features = {}, featureArtifacts = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const _featureArtifacts = Object.assign(Object.assign({}, DEFAULT_BOOTSTRAP_FEATURE_ARTIFACTS), featureArtifacts);
        return {
...
function deployFullFeaturesAsync(provider, txDefaults, config = {}, features = {}, featureArtifacts = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const _config = Object.assign(Object.assign({}, DEFAULT_FULL_FEATURES_DEPLOY_CONFIG), config);
        const _featureArtifacts = Object.assign(Object.assign({}, DEFAULT_FULL_FEATURES_ARTIFACTS), featureArtifacts);
        ...
        return Object.assign(Object.assign({}, (yield deployBootstrapFeaturesAsync(provider, txDefaults))), { transformERC20: features.transformERC20 ||
                (yield wrappers_1.TransformERC20FeatureContract.deployFrom0xArtifactAsync(_featureArtifacts.transformERC20, provider, txDefaults, artifacts_1.artifacts)).address, metaTransactions: features.metaTransactions ||
                (yield wrappers_1.MetaTransactionsFeatureContract.deployFrom0xArtifactAsync(_featureArtifacts.metaTransactions, provider, txDefaults, artifacts_1.artifacts, _config.zeroExAddress)).address, nativeOrders: features.nativeOrders ||
                (yield wrappers_1.NativeOrdersFeatureContract.deployFrom0xArtifactAsync(_featureArtifacts.nativeOrders, provider, txDefaults, artifacts_1.artifacts, _config.zeroExAddress, _config.wethAddress, _config.stakingAddress, _config.feeCollectorController, _config.protocolFeeMultiplier)).address });
    });
}
...
function fullMigrateAsync(owner, provider, txDefaults, features = {}, config = {}, featureArtifacts = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const _config = Object.assign(Object.assign({}, config), { zeroExAddress: zeroEx.address });
