...
exports.eip712Utils = {
    ...
    createCoordinatorApprovalTypedData(transaction, verifyingContract, txOrigin) {
        const domain = Object.assign(Object.assign({}, transaction.domain), { name: constants_1.constants.COORDINATOR_DOMAIN_NAME, version: constants_1.constants.COORDINATOR_DOMAIN_VERSION, verifyingContract });
    ...
    createExchangeProxyMetaTransactionTypedData(mtx) {
        ...
        v => (utils_1.BigNumber.isBigNumber(v) ? v.toString(10) : v)), Object.assign(Object.assign({}, constants_1.constants.MAINNET_EXCHANGE_PROXY_DOMAIN), mtx.domain));
    },
};
