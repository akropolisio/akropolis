...
export declare const marketUtils: {
     ...
     */
    findOrdersThatCoverMakerAssetFillAmount<T_1 extends Order>(orders: T_1[], makerAssetFillAmount: BigNumber, opts?: FindOrdersThatCoverMakerAssetFillAmountOpts | undefined): OrdersAndRemainingMakerFillAmount<T_1>;
    /**
     ...
     */
    findFeeOrdersThatCoverFeesForTargetOrders<T_2 extends Order>(orders: T_2[], feeOrders: T_2[], opts?: FindFeeOrdersThatCoverFeesForTargetOrdersOpts | undefined): FeeOrdersAndRemainingFeeAmount<T_2>;
};
