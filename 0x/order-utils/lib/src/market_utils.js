...
function findOrdersThatCoverAssetFillAmount(orders, assetFillAmount, operation, opts) {
    ...
    if (operation === types_1.MarketOperation.Buy) {
        return Object.assign(Object.assign({}, ordersAndRemainingFillAmount), { ordersRemainingFillableMakerAssetAmounts: resultOrdersRemainingFillableAssetAmounts });
    }
    else {
        return Object.assign(Object.assign({}, ordersAndRemainingFillAmount), { ordersRemainingFillableTakerAssetAmounts: resultOrdersRemainingFillableAssetAmounts });
    }
}
