...
exports.orderFactory = {
    createOrderFromPartial(partialOrder) {
        ...
        return Object.assign(Object.assign({}, defaultOrder), partialOrder);
    },
    createSignedOrderFromPartial(partialSignedOrder) {
        ...
        return Object.assign(Object.assign({}, defaultOrder), partialSignedOrder);
    },
...
function generateEmptySignedOrder(chainId) {
    return Object.assign(Object.assign({}, generateEmptyOrder(chainId)), { signature: constants_1.constants.NULL_BYTES });
}
