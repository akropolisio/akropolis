...
exports.isValidECSignature = exports.parseSignatureHexAsVRS = exports.signatureUtils = void 0;
    ...
    ecSignOrderAsync(supportedProvider, order, signerAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const signedOrder = Object.assign(Object.assign({}, order), { signature: signatureHex });
                return signedOrder;
            }
        });
    },
    ...
    ecSignTypedDataOrderAsync(supportedProvider, order, signerAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return Object.assign(Object.assign({}, order), { signature: signatureHex });
            }
            catch (err) {
    ...
    ecSignTransactionAsync(supportedProvider, transaction, signerAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const signedTransaction = Object.assign(Object.assign({}, transaction), { signature: signatureHex });
                return signedTransaction;
            }
        });
    },
    ...
    ecSignTypedDataTransactionAsync(supportedProvider, transaction, signerAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const signatureHex = `0x${signatureBuffer.toString('hex')}`;
                return Object.assign(Object.assign({}, transaction), { signature: signatureHex });
            }
            catch (err) {
                // Detect if Metamask to transition users to the MetamaskSubprovider
                if (provider.isMetaMask) {
