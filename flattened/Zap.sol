...
contract Zap is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    // use the standard contract for 0x api

    //swap ERC20 -> ERC20 tokens held by this smart contract using 0x api quote
    function fillQuote(
        // sellTokenAddress field from API
        IERC20 sellToken,
        // buyToken Address field from API
        IERC20 buyToken,
        // allowanceTarget fielf from API
        address spender,
        // to field from API
        ...
        sellToken.safeApprove(spender, uint256(-1));
