...
def test_successful_claim_reward(deployer, rewards, token, regular_user, regular_user2, regular_user3, regular_user4):
...
def test_wrong_leaf(deployer, rewards, token, regular_user, regular_user2, regular_user3, regular_user4):
    users = [regular_user, regular_user2, regular_user3, regular_user4]
    values = [AVAILABLE_USER1, AVAILABLE_USER2, AVAILABLE_USER3, AVAILABLE_USER4]
    root, hshs = prepare_root(users, values)
    h1, h2, h3, h4, root_1, root_2 = hshs
...
def test_successful_claim_new_part(deployer, rewards, token, regular_user, regular_user2, regular_user3, regular_user4):
    users = [regular_user, regular_user2, regular_user3, regular_user4]
    values = [AVAILABLE_USER1, AVAILABLE_USER2, AVAILABLE_USER3, AVAILABLE_USER4]
    root, hshs = prepare_root(users, values)
    h1, h2, h3, h4, root_1, root_2 = hshs
...
def test_claim_reward_over(deployer, rewards, token, regular_user, regular_user2, regular_user3, regular_user4):
    users = [regular_user, regular_user2, regular_user3, regular_user4]
    values = [AVAILABLE_USER1, AVAILABLE_USER2, AVAILABLE_USER3, AVAILABLE_USER4]
    root, hshs = prepare_root(users, values)
    h1, h2, h3, h4, root_1, root_2 = hshs
...
def test_claim_reward_from_empty_pool(deployer, rewards, token, regular_user, regular_user2, regular_user3, regular_user4):
    users = [regular_user, regular_user2, regular_user3, regular_user4]
    values = [AVAILABLE_USER1, AVAILABLE_USER2, AVAILABLE_USER3, AVAILABLE_USER4]
    root, hshs = prepare_root(users, values)
    h1, h2, h3, h4, root_1, root_2 = hshs
...
def test_claim_reward_with_wrong_index(deployer, rewards, token, regular_user, regular_user2, regular_user3, regular_user4):
    users = [regular_user, regular_user2, regular_user3, regular_user4]
    values = [AVAILABLE_USER1, AVAILABLE_USER2, AVAILABLE_USER3, AVAILABLE_USER4]
    root, hshs = prepare_root(users, values)
    h1, h2, h3, h4, root_1, root_2 = hshs
...
def test_min_claim_amount(deployer, rewards, token, regular_user, regular_user2, regular_user3, regular_user4):
    users = [regular_user, regular_user2, regular_user3, regular_user4]
    values = [AVAILABLE_USER1, AVAILABLE_USER2, AVAILABLE_USER3, AVAILABLE_USER4]
    root, hshs = prepare_root(users, values)
    h1, h2, h3, h4, root_1, root_2 = hshs
...
def test_claim_reward_on_pause(deployer, rewards, token, regular_user, regular_user2, regular_user3, regular_user4):
    users = [regular_user, regular_user2, regular_user3, regular_user4]
    values = [AVAILABLE_USER1, AVAILABLE_USER2, AVAILABLE_USER3, AVAILABLE_USER4]
    root, hshs = prepare_root(users, values)
    h1, h2, h3, h4, root_1, root_2 = hshs
