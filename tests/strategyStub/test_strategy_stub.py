...
def test_vault_setup_strategy(
    ...
    )  # dumb yield generated and transfered as profit to the vault

    # Supply of LP tokens is increased
    assert (
        vault.totalSupply() == DEPOSIT_VALUE + YIELD_FEE_SHARES + STRATEGIST_FEE_SHARES
    )
